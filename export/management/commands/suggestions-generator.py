        ...
        for i in special_offers:
            for t in range(0, total_months):
                ...
                transaction_record = {
                    ...
                    'description': "{}. Spend category: Special offer demo".format(new_transaction.description),
                    'text_field': "{}. Spend category: Special offer demo".format(new_transaction.description),
